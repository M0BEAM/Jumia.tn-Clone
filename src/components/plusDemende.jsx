import img1 from "../assets/images/lpd (1).png"
import img2 from "../assets/images/lpd (2).png"
import img3 from "../assets/images/lpd (3).png"
import img4 from "../assets/images/lpd (4).png"
    ...
    return ( 
        ...
        <div className="overflow-x-scroll">
          ...
          <div className="flex justify-center xl:gap-6 w-max lg:w-full ml-2 ">
            {/* card1 */}
            <div className=" m-4">
              <img className="size-72 lg:w-full" src={img1} alt="" />
            ...
            {/* card1 */}
            <div className=" m-4">
              <img className="size-72 lg:w-full" src={img2} alt="" />
              <p>Infinix Pack Note 30 Gold - 8G…</p>
              <p className="font-bold">679.00 TND</p>
              <p className="line-through">799.00 TND</p>
              <div className="w-full">
